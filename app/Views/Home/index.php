    ...
    <div class="wp-inner">
        <div class="main-content fl-right">
            <div class="section" id="slider-wp">
                <div class="section-detail">
                    <div class="item">
                        <img src="<?= home_url() ?>/images/slider-01.png" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= home_url() ?>/images/slider-02.png" alt="">
                    </div>
                    <div class="item">
                        <img src="<?= home_url() ?>/images/slider-03.png" alt="">
                    </div>
                </div>
            </div>
            <div class="section" id="support-wp">
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            <div class="thumb">
                                <img src="<?= home_url() ?>/images/icon-1.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?= home_url() ?>/images/icon-2.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?= home_url() ?>/images/icon-3.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?= home_url() ?>/images/icon-4.png">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="<?= home_url() ?>/images/icon-5.png">
                            </div>
                    ...
                    <ul class="list-item">
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-05.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-08.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-07.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-10.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-06.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-09.png">
                            </a>
            ...
            <div class="section" id="list-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-16.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-15.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-14.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-13.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-12.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-11.png">
                            </a>
                    ...
                    <ul class="list-item clearfix">
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-17.png">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-18.png">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-19.png">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-20.png">
                            </a>
                            <a href="" title="" class="product-name">Laptop Lenovo IdeaPad 110</a>
                            <div class="price">
                                <span class="new">6.990.000đ</span>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-21.png">
                            </a>
                            <a href="" title="" class="product-name">Laptop Asus X441NA</a>
                            <div class="price">
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-22.png">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="<?= home_url() ?>/images/img-pro-23.png">
                            </a>
        ...
        <div class="sidebar fl-left">
                    ...
                    <ul class="list-item">
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-13.png" alt="">
                            </a>
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-12.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-05.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-22.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-18.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="<?= home_url() ?>/images/img-pro-15.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
            ...
            <div class="section" id="banner-wp">
                <div class="section-detail">
                    <a href="" title="" class="thumb">
                        <img src="<?= home_url() ?>/images/banner.png" alt="">
                    </a>
                </div>
            </div>
        </div>
